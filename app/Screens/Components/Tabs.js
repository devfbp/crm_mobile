...
const Tabs = () => {
    ...
    const scrollViewHome1 = useRef(null);
    const scrollViewHome2 = useRef(null);

    const onClick1 = (i) => {
        if (scrollViewHome1.current) {
        scrollViewHome1.current.scrollTo({ x: i * width - 60, animated: true });
        }
    };

    const onClick2 = (i) => {
        if (scrollViewHome2.current) {
        scrollViewHome2.current.scrollTo({ x: i * width - 60, animated: true });
        }
    };
                    ...
                    <View style={GlobalStyleSheet.container}>
                        <View style={[GlobalStyleSheet.card,{
                            ...
                            <View style={{paddingBottom:15}}>
                                <TabButtonStyle1 buttons={buttons} onClick={onClick1} scrollX={scrollX} />
                            </View>
                            <ScrollView
                                ref={scrollViewHome1}
                                horizontal
